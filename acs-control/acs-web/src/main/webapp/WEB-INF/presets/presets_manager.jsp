...
%>
		...
		<link href="<%=basePath %>resources/presets/css/presets.css" rel="stylesheet">
		...
		<div class="content">
			...
			<div class="mainbar">
				...
				<!-- Page heading -->
				<div class="page-head">
					<h2 class="pull-left"><i class="icon-list-alt"></i>Template</h2>
					<!-- Breadcrumb -->
						...
						<nav role="navigation" class="collapse navbar-collapse bs-navbar-collapse">
							<ul class="nav navbar-nav">
								...
								<li class="dropdown dropdown-big">
									<a data-toggle="dropdown" class="dropdown-toggle" href="#" onclick="addPresets();return false;"><span class="label label-danger"><i class="icon-plus"></i></span> Add Template</a>
								</li>
							</ul>
							<!-- Search form -->
							<div class="form-group">
								<form role="search" class="navbar-form navbar-right">
									...
									<input type="text" placeholder="Search" id="preset_search" class="form-control" style="width: 200px;">
									<span class="am-search-span">
										<input type="button" value="Search" class="am-search-span-btn" onclick="serarchPreset()"/>
								    </span>
								</form>
							</div>
						</nav>
...
<!-- 											<th>Description</th> -->
								...
								<div class="widget-foot" >
									...
									<ul class="pagination pull-right" id="perset_page">
<!-- 										<li><a href="#">Prev</a></li> -->
<!-- 										<li><a href="#">1</a></li> -->
<!-- 										<li><a href="#">2</a></li> -->
<!-- 										<li><a href="#">3</a></li> -->
...
<!-- 										<li><a href="#">Next</a></li> -->
		...
		<!-- Content ends -->
		<!-- Modal -->
        <jsp:include page="presetsModal.jsp"></jsp:include>
	<jsp:include page="../foot.jsp"></jsp:include>
	<script src="<%=basePath %>resources/js/jquery.form.js"></script>  
	<script src="<%=basePath %>resources/presets/js/presetsIndex.js"></script>